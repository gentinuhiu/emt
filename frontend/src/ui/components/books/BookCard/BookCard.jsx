        ...
        <>
            <Card sx={{boxShadow: 3, borderRadius: 2, p: 1}}>
                <CardContent>
                    ...
                    <Typography variant="h6">By: {book.author.name} {book.author.surname}</Typography>
                    ...
                    {/*            sx={{textAlign: "right", fontSize: "1.25rem"}}>${book.price}</Typography>*/}
                    {/*<Typography variant="body2" sx={{textAlign: "right"}}>{book.quantity} piece(s)*/}
